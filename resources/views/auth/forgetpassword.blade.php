            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form action="{{ route('forget.password.post') }}" method="POST" class="register-form" id="login-form">
                            @csrf
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="signin" id="signin" class="form-submit" value="Email Password Reset Link" />
                            </div>
                        </form>
